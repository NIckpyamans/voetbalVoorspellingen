...
const KNOWN_VENUES = {
  ...
  "blackburn": { name: "Ewood Park", city: "Blackburn", lat: 53.7286, lon: -2.4892 },
  "bristol city": { name: "Ashton Gate", city: "Bristol", lat: 51.44, lon: -2.6203 },
  "borussia dortmund": { name: "Signal Iduna Park", city: "Dortmund", lat: 51.4926, lon: 7.4519 },
  "dortmund": { name: "Signal Iduna Park", city: "Dortmund", lat: 51.4926, lon: 7.4519 },
  "burnley": { name: "Turf Moor", city: "Burnley", lat: 53.789, lon: -2.2302 },
  "cadiz": { name: "Estadio Nuevo Mirandilla", city: "Cadiz", lat: 36.5027, lon: -6.2729 },
  "chelsea": { name: "Stamford Bridge", city: "London", lat: 51.4816, lon: -0.191 },
  "cagliari": { name: "Unipol Domus", city: "Cagliari", lat: 39.1995, lon: 9.1357 },
  "celta": { name: "Estadio de Balaidos", city: "Vigo", lat: 42.2119, lon: -8.7397 },
  "celtic": { name: "Celtic Park", city: "Glasgow", lat: 55.8497, lon: -4.2056 },
  "coventry": { name: "Coventry Building Society Arena", city: "Coventry", lat: 52.4481, lon: -1.4956 },
  "como": { name: "Stadio Giuseppe Sinigaglia", city: "Como", lat: 45.812, lon: 9.0721 },
  "cremonese": { name: "Stadio Giovanni Zini", city: "Cremona", lat: 45.1377, lon: 10.0318 },
  "crystal palace": { name: "Selhurst Park", city: "London", lat: 51.3983, lon: -0.0855 },
  "derby": { name: "Pride Park Stadium", city: "Derby", lat: 52.915, lon: -1.4472 },
  "dusseldorf": { name: "Merkur Spiel-Arena", city: "Dusseldorf", lat: 51.2617, lon: 6.7331 },
  "eintracht frankfurt": { name: "Deutsche Bank Park", city: "Frankfurt", lat: 50.0686, lon: 8.6454 },
  "espanyol": { name: "RCDE Stadium", city: "Cornella de Llobregat", lat: 41.3479, lon: 2.0757 },
  "espanol": { name: "RCDE Stadium", city: "Cornella de Llobregat", lat: 41.3479, lon: 2.0757 },
  "elche": { name: "Estadio Manuel Martinez Valero", city: "Elche", lat: 38.2668, lon: -0.6639 },
  "empoli": { name: "Stadio Carlo Castellani", city: "Empoli", lat: 43.7264, lon: 10.9478 },
  "everton": { name: "Goodison Park", city: "Liverpool", lat: 53.4388, lon: -2.9663 },
  "excelsior": { name: "Van Donge & De Roo Stadion", city: "Rotterdam", lat: 51.9163, lon: 4.5202 },
  ...
  "feyenoord": { name: "De Kuip", city: "Rotterdam", lat: 51.8939, lon: 4.5231 },
  "fiorentina": { name: "Stadio Artemio Franchi", city: "Florence", lat: 43.7808, lon: 11.2822 },
  ...
  "fulham": { name: "Craven Cottage", city: "London", lat: 51.4749, lon: -0.2216 },
  "genoa": { name: "Stadio Luigi Ferraris", city: "Genoa", lat: 44.4164, lon: 8.9525 },
  "girona": { name: "Estadi Montilivi", city: "Girona", lat: 41.9611, lon: 2.8288 },
  ...
  "hamburg": { name: "Volksparkstadion", city: "Hamburg", lat: 53.5872, lon: 9.8986 },
  "hertha berlin": { name: "Olympiastadion Berlin", city: "Berlin", lat: 52.5147, lon: 13.2395 },
  "huesca": { name: "Estadio El Alcoraz", city: "Huesca", lat: 42.1319, lon: -0.4086 },
  "inter": { name: "San Siro", city: "Milan", lat: 45.4781, lon: 9.124 },
  "ipswich": { name: "Portman Road", city: "Ipswich", lat: 52.055, lon: 1.1457 },
  "kaiserslautern": { name: "Fritz-Walter-Stadion", city: "Kaiserslautern", lat: 49.4347, lon: 7.7764 },
  "koln": { name: "RheinEnergieStadion", city: "Cologne", lat: 50.9335, lon: 6.8751 },
  "juventus": { name: "Allianz Stadium", city: "Turin", lat: 45.1096, lon: 7.6413 },
  "las palmas": { name: "Estadio Gran Canaria", city: "Las Palmas", lat: 28.1, lon: -15.4567 },
  "leeds": { name: "Elland Road", city: "Leeds", lat: 53.7778, lon: -1.5721 },
  "leganes": { name: "Estadio Municipal de Butarque", city: "Leganes", lat: 40.3409, lon: -3.7608 },
  "liverpool": { name: "Anfield", city: "Liverpool", lat: 53.4308, lon: -2.9608 },
  "luton": { name: "Kenilworth Road", city: "Luton", lat: 51.8842, lon: -0.4317 },
  "mainz": { name: "MEWA Arena", city: "Mainz", lat: 49.9842, lon: 8.2242 },
  "mallorca": { name: "Estadi Mallorca Son Moix", city: "Palma", lat: 39.5908, lon: 2.6306 },
  ...
  "middlesbrough": { name: "Riverside Stadium", city: "Middlesbrough", lat: 54.5783, lon: -1.2169 },
  "milan": { name: "San Siro", city: "Milan", lat: 45.4781, lon: 9.124 },
  "millwall": { name: "The Den", city: "London", lat: 51.4859, lon: -0.0509 },
  "monchengladbach": { name: "Borussia-Park", city: "Monchengladbach", lat: 51.1746, lon: 6.3855 },
  "napoli": { name: "Stadio Diego Armando Maradona", city: "Naples", lat: 40.8279, lon: 14.1931 },
  "norwich": { name: "Carrow Road", city: "Norwich", lat: 52.6221, lon: 1.3091 },
  "nurnberg": { name: "Max-Morlock-Stadion", city: "Nuremberg", lat: 49.4263, lon: 11.1257 },
  "osasuna": { name: "El Sadar", city: "Pamplona", lat: 42.7967, lon: -1.6375 },
  ...
  "portsmouth": { name: "Fratton Park", city: "Portsmouth", lat: 50.7964, lon: -1.0639 },
  "preston": { name: "Deepdale", city: "Preston", lat: 53.7724, lon: -2.688 },
  "psv": { name: "Philips Stadion", city: "Eindhoven", lat: 51.4418, lon: 5.4674 },
  "psg": { name: "Parc des Princes", city: "Paris", lat: 48.8414, lon: 2.253 },
  "qpr": { name: "Loftus Road", city: "London", lat: 51.5093, lon: -0.2322 },
  "racing santander": { name: "Campos de Sport de El Sardinero", city: "Santander", lat: 43.4763, lon: -3.7935 },
  "rangers": { name: "Ibrox Stadium", city: "Glasgow", lat: 55.8532, lon: -4.3093 },
  "real betis": { name: "Estadio Benito Villamarin", city: "Seville", lat: 37.3565, lon: -5.9817 },
  "real sociedad": { name: "Reale Arena", city: "San Sebastian", lat: 43.3014, lon: -1.9736 },
  "roma": { name: "Stadio Olimpico", city: "Rome", lat: 41.9339, lon: 12.4547 },
  "sampdoria": { name: "Stadio Luigi Ferraris", city: "Genoa", lat: 44.4164, lon: 8.9525 },
  "sassuolo": { name: "Mapei Stadium", city: "Reggio Emilia", lat: 44.7144, lon: 10.6497 },
  "schalke": { name: "Veltins-Arena", city: "Gelsenkirchen", lat: 51.5545, lon: 7.0676 },
  "sevilla": { name: "Ramon Sanchez-Pizjuan", city: "Seville", lat: 37.384, lon: -5.9705 },
  "sheffield united": { name: "Bramall Lane", city: "Sheffield", lat: 53.3703, lon: -1.4708 },
  "sparta rotterdam": { name: "Het Kasteel", city: "Rotterdam", lat: 51.9202, lon: 4.4326 },
  "stoke": { name: "bet365 Stadium", city: "Stoke-on-Trent", lat: 52.9883, lon: -2.1756 },
  "sunderland": { name: "Stadium of Light", city: "Sunderland", lat: 54.9144, lon: -1.3882 },
  ...
  "twente 65": { name: "De Grolsch Veste", city: "Enschede", lat: 52.2369, lon: 6.8375 },
  "udinese": { name: "Stadio Friuli", city: "Udine", lat: 46.0812, lon: 13.1994 },
  ...
  "valencia": { name: "Mestalla", city: "Valencia", lat: 39.4746, lon: -0.3583 },
  "verona": { name: "Stadio Marcantonio Bentegodi", city: "Verona", lat: 45.4354, lon: 10.9689 },
  "villarreal": { name: "Estadio de la Ceramica", city: "Villarreal", lat: 39.9442, lon: -0.1036 },
  "vitesse": { name: "GelreDome", city: "Arnhem", lat: 51.9633, lon: 5.8939 },
  "watford": { name: "Vicarage Road", city: "Watford", lat: 51.6498, lon: -0.4015 },
  "werder bremen": { name: "Weserstadion", city: "Bremen", lat: 53.0665, lon: 8.8376 },
  "west brom": { name: "The Hawthorns", city: "West Bromwich", lat: 52.509, lon: -1.9639 },
