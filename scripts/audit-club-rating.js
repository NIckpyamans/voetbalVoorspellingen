...
import { buildClubStrengthProfile, lookupClubEloProfile } from "./worker/club-strength.js";
...
for (const match of day.matches || []) {
  ...
  for (const side of ["home", "away"]) {
    ...
    const strength = buildClubStrengthProfile({snapshot, clubEloProfile, squadProfile, asOf});
