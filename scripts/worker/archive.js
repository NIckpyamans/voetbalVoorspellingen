...
export function buildSplitMeta(store) {
  return {
    ...
    enrichmentPublicationGate: store.enrichmentPublicationGate || null,
    targetedRepairSummary: store.targetedRepairSummary || null,
    competitionQuality: store.competitionQuality || [],
