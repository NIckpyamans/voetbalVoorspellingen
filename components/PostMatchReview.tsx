    ...
    <div className="bg-gradient-to-br from-emerald-950/40 to-slate-950/60 border border-emerald-500/20 rounded-xl p-2.5 space-y-2">
      <div className="flex items-center justify-between gap-2">
        <div>
          ...
          <div className="text-[9px] text-slate-300">voorspelling versus echte uitslag</div>
        </div>
        <div className={`text-[8px] font-black px-2 py-0.5 rounded-full ${review.outcomeHit ? "bg-green-900/40 text-green-300" : "bg-red-900/40 text-red-300"}`}>
          {review.outcomeHit ? "Uitkomst goed" : "Uitkomst fout"}
        </div>
      </div>
